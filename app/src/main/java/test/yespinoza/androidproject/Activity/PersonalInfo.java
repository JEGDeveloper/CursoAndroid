...
public class PersonalInfo extends AppCompatActivity {
    ...
    public void createUser(View pView) {
        ...
        String userName = ((EditText) findViewById(R.id.etIdNumber)).getText().toString();
        ...
        oUser = new User(Helper.TextFormat(userName), Helper.TextFormat(name), Helper.TextFormat(lastName), email, Helper.TextFormat(phone), dateOfBirth, Helper.TextFormat(address));
        activityRedirection();
    }
